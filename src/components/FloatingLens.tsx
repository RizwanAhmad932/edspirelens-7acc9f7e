...
import { X, Minimize2, Maximize2, GripVertical, BookOpen, Search, BrainCircuit, Loader2 } from "lucide-react";
...
const FloatingLens = ({ isOpen, onClose, summary, transcript, quiz, quizLoading, videoTitle, onQuizComplete }: FloatingLensProps) => {
              ...
              <TabsContent value="quiz">
                {quizLoading ? (
                  <div className="flex flex-col items-center justify-center py-8 gap-3">
                    ...
                    <p className="text-xs text-muted-foreground">Generating quiz with AI...</p>
                  </div>
                ) : quiz.length > 0 ? (
